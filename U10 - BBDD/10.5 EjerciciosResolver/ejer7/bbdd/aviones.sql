...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-01-2025 a las 16:42:57
...
(4, 'Suisei', 305, 'img/suisei.jpg', ' El D4Y fue uno de los bombarderos en picado más veloces utilizados durante la II Guerra Mundial. A pesar de su uso limitado, su velocidad y autonomía lo hizo eficaz en misiones de reconocimiento así como en ataques kamikaze. '),
(5, 'BoeingB17', 310, 'img/BoeingB17.jpg', 'El Boeing B-17 Flying Fortress es un famoso bombardero pesado cuatrimotor de la Segunda Guerra Mundial, fabricado desde 1935 y puesto en servicio en 1937 con el Cuerpo Aéreo del Ejército de los Estados Unidos (USAAC) y la Real Fuerza Aérea británica (RAF). '),
(6, 'Nakajima B5N', 310, 'img/kate.jpg', 'El Nakajima B5N (en japonés: 中島 B5N, nombre en código Aliado: \"Kate\") fue el avión torpedero estándar de la Armada Imperial Japonesa con la denominación Bombardero de Ataque Embarcado Tipo 97 Modelo 1 de la Armada durante buena parte de la guerra.'),
(7, 'Lisunov Li-2', 290, 'img/lusinov.jpg', 'El Lisunov Li-2, originalmente designado PS-84 (designación OTAN: Cab), era una versión construida bajo licencia del Douglas DC-3. Fue fabricado por el GAZ-84 cerca de Moscú, y posteriormente por el GAZ-34 en Tashkent.');
